...
class Empleados extends Personas implements Comparable, ParaTrabajadores{
	...
	public String getDescripcion() {
		...
		return "El empleado "+this.getNombre()+" tiene un sueldo de "
				+sueldo+" euros "+"y entro a trabajar en "+fechaAlta;
	}
	...
	public double setBonus(double gratificacion) {
		// TODO Auto-generated method stub
		return ParaTrabajadores.bunus+gratificacion;
	}
}
...
class Jefes extends Empleados implements ParaJefes {
	...
	public String getCargo() {
		...
		public double setBonus(double gratificacion) {
			// TODO Auto-generated method stub
			double prima=2000;
			return prima+gratificacion+ParaTrabajadores.bunus;
		}
}
...
class Alumnos extends Personas {
	...
	public String getDescripcion() {
		// TODO Auto-generated method stub
		return "El alumno "+this.getNombre()+" esta en el aula "+aula+" y"
